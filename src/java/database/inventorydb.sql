...
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`)
	VALUES ('cprg352+admin2@gmail.com', true, 'Admin2','Admin2', 'password', 1);
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`)
...
INSERT INTO `item` (`category`,`item_name`,`price`,`owner`) VALUES (5, 'dresser',5,'cprg352+anne@gmail.com');
